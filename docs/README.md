...
<ul>
  <li><a target="_blank" href="./coverage/api_lambda-tarpaulin-report.html">カバレッジレポート(API)</a></li>
  <li><a target="_blank" href="./rust-doc/sns_system_api_lambda/sns_system_api_lambda/index.html">Rustドキュメント(API)</a></li>
  <li><a target="_blank" href="./coverage/auth_PreSignUpFunction-tarpaulin-report.html">カバレッジレポート(PreSignUpFunction)</a></li>
  ...
  <li><a target="_blank" href="./coverage/core-tarpaulin-report.html">カバレッジレポート(core)</a></li>
